...
export default function EmployeeOnboardingPage() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setSteps([
        { id: '1', title: 'Arbeitsvertrag', description: 'Arbeitsvertrag wurde erstellt und unterschrieben.', status: 'completed', completedAt: '2026-03-01' },
        { id: '2', title: 'IT-Ausstattung', description: 'Laptop, Bildschirm und Peripheriegeräte bereitgestellt.', status: 'completed', completedAt: '2026-03-03' },
        { id: '3', title: 'Tool-Zugänge', description: 'E-Mail, Slack, GitHub und weitere Tool-Zugänge eingerichtet.', status: 'in_progress' },
        { id: '4', title: 'Einarbeitung', description: 'Strukturierte Einarbeitung mit Mentor und Dokumentation.', status: 'pending' },
        { id: '5', title: 'Probezeit-Review', description: 'Feedbackgespräch und Bewertung nach der Probezeit.', status: 'pending' },
      ])
      setIsLoading(false)
    }, 400)
  ...
  return (
    <div>
      <PageHeader title="Mitarbeiter-Onboarding" subtitle="Checklisten für neue Mitarbeiter">
        {steps.length > 0 && (
      ...
      {isLoading ? <Spinner /> : steps.length > 0 ? (
        ...
        <EmptyState icon={UserCheck} title="Kein Onboarding" description="Es gibt noch keine Mitarbeiter-Onboarding Checklisten." />
      )}
    </div>
  )
}
